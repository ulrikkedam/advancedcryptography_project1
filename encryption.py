...
def mix_single_column(col):
    ...
    temp = col.copy()
    col[0] = xtime(temp[0]) ^ xtime(temp[1]) ^ temp[1] ^ temp[2] ^ temp[3]& 0xFF
    col[1] = temp[0] ^ xtime(temp[1]) ^ xtime(temp[2]) ^ temp[2] ^ temp[3]& 0xFF
    col[2] = temp[0] ^ temp[1] ^ xtime(temp[2]) ^ xtime(temp[3]) ^ temp[3]& 0xFF
